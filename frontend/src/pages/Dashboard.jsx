...
// REMOVED calculateDate FROM THE IMPORT BELOW TO FIX THE ERROR
import { getTimeFrameRange, getPreviousTimeFrameRange } from "../components/Helpers";
import axios from "axios";
// FIXED: Added Wallet to your lucide-react imports
import { Plus, Wallet } from "lucide-react";

// FIXED: Imported your FinancialCard component (Adjust this path if your folder layout is different!)
...
// Fallback logic for calculateData if not imported
...
const Dashboard = () => {
  ...
  // Update the gauge when data or time frame changes
  useEffect(() => {
    const maxValues = {
  ...
  // Fetch server side overview data
