                ...
                <div className={loginStyles.formContainer}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-6">
                            ...
                            <div className={`${loginStyles.inputContainer} relative`}>
                                <div className={loginStyles.inputIcon}>
                                ...
                                <input
                                    ...
                                    className={`${loginStyles.passwordInput || loginStyles.input} pr-10`} 
                                    placeholder="••••••••"
                                    required
                                />
                                <button
                        ...
                        <button 
                            type="submit" 
                            disabled={isLoading}
                            className="w-full flex items-center justify-center py-2 bg-blue-600 text-white rounded hover:bg-blue-700 disabled:opacity-50 transition-colors"
                        >
                            {isLoading ? (
                                <div className="flex items-center justify-center gap-2">
                                    <svg className={`${loginStyles.spinner || "animate-spin h-5 w-5 text-white"}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
